...
#include "../../Qt_widget_for_Panttibotti/mytcpclient.h"
...
QT_MOC_LITERAL(4, 28, 15), // "myConnectedSlot"
QT_MOC_LITERAL(5, 44, 7), // "receive"
QT_MOC_LITERAL(6, 52, 18) // "myDisconnectedSlot"

    },
    "MyTcpClient\0finished\0\0debug\0myConnectedSlot\0"
    "receive\0myDisconnectedSlot"
};
...
void MyTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->myConnectedSlot(); break;
        case 3: _t->receive(); break;
        case 4: _t->myDisconnectedSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::finished)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyTcpClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::debug)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpClient::finished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyTcpClient::debug()
{
